//To implement a program in c for In-order, Pre-order, Post-order Traversals. 
#include <stdio.h> 
#include <stdlib.h> 
...
{ 
 ...
 printf("\n"); 
    ...
    printf("\nThe post-order traversal of the given binary tree is - \n"); 
   
  postOrder(root); 
    printf("\n"); 
  
    // Perform pre-order traversal 
    printf("\nThe pre-order traversal of the given binary tree is - \n"); 
    preOrder(root); 
    printf("\n"); 
